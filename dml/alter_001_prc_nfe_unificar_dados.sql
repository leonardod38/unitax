...
-- Schema  : USER_XMLS
-- Arquivo : alter_001_prc_nfe_unificar_dados.sql
-- Descricao: Script completo com todas as alteracoes 001
--            aplicadas. Une os scripts 001a, 001b, 001c, 001d.
--            Aplica cabecalho + I16_VFRETE em CURSOR, INSERT
--            e VALUES.
-- Execucao : Compilar diretamente no banco Oracle.
--            Apos execucao rodar: EXEC PRC_RECOMPILAR_OBJETOS;
-- ------------------------------------------------------------
-- Historico de alteracoes:
-- 001 - 2026-06-03 - Adicionado I16_VFRETE (frete por item)
--                    em CURSOR SELECT, INSERT colunas e VALUES
-- ============================================================

-- 001 - ajuste no campo frete
ALTER TABLE TB_UNIFICADA_RF ADD (I16_VFRETE VARCHAR2(50))
/
...
-- Objeto  : PRC_NFE_UNIFICAR_DADOS
-- Schema  : USER_XMLS
-- Descricao: Une TB_REFORMA_CONSOLIDADA (tributos antigos) com
--            TB_REFORMA_TRIBUTARIA (tributos RF: IS, IBS, CBS)
--            via LEFT JOIN e carrega o resultado em
--            TB_UNIFICADA_RF via BULK COLLECT / FORALL.
--            Erros individuais gravados em TB_LOG_NFE_REFORMA
--            via transacao autonoma (gravar_log).
-- Fonte   : TB_REFORMA_CONSOLIDADA + TB_REFORMA_TRIBUTARIA
-- Destino : TB_UNIFICADA_RF
-- Log     : TB_LOG_NFE_REFORMA
-- ------------------------------------------------------------
-- Historico de alteracoes:
-- 001 - 2026-06-03 - Adicionado I16_VFRETE (frete por item)
--                    em CURSOR SELECT, INSERT colunas e VALUES
-- ============================================================
    ...
    CURSOR c_unificado IS
        SELECT /*+ PARALLEL(8) */
            ...
            c.I02_CPROD, c.I03_CEAN, c.I04_XPROD, c.I05_NCM, c.I08_CFOP, c.I09_UCOM, c.I10_QCOM, c.I10A_VUNCOM, c.I11_VPROD, c.I12_CEANTRIB, c.I13_UTRIB, c.I14_QTRIB, c.I14A_VUNTRIB, c.I15_VDESC, c.I16_VFRETE, -- 001 - ajuste no campo frete
            c.I17B_INDTOT,
        ...
        BEGIN
            FORALL i IN 1 .. v_array.COUNT SAVE EXCEPTIONS
                INSERT INTO TB_UNIFICADA_RF (
                    ...
                    I02_CPROD, I03_CEAN, I04_XPROD, I05_NCM, I08_CFOP, I09_UCOM, I10_QCOM, I10A_VUNCOM, I11_VPROD, I12_CEANTRIB, I13_UTRIB, I14_QTRIB, I14A_VUNTRIB, I15_VDESC, I16_VFRETE, -- 001 - ajuste no campo frete
                    I17B_INDTOT,
