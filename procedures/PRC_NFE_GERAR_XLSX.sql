...
BEGIN
   ...
   IF v_total_linhas >= c_limite_csv THEN
      ...
      FOR rec IN (
         ...
         -- Grupo 1: identificação e emitente
         UTL_FILE.PUT(v_handle,
         ...
         -- Grupo 2: destinatário e produto
         UTL_FILE.PUT(v_handle,
         ...
         -- Grupo 5: tributação reforma, monofásico, transferências, ajustes
         UTL_FILE.PUT(v_handle,
   ...
   ELSE
      ...
      -- 6. Cabeçalho com cores, bordas e alinhamento
      ...
      -- 8. Validação, comentários e filtros
...
EXCEPTION
   WHEN OTHERS THEN
      ...
      -- Fecha UTL_FILE se estiver aberto
      BEGIN
