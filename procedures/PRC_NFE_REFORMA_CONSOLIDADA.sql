...
-- ============================================================
-- Tipo    : PROCEDURE
-- Objeto  : PRC_NFE_REFORMA_CONSOLIDADA
-- Schema  : USER_XMLS
-- Descricao: Lê XMLs de NF-e (formato nfeProc) da STG_NFE,
--            extrai dados via XMLTABLE em dois níveis
--            (CAPA: /nfeProc | DETALHE: /det) e carrega em
--            TB_REFORMA_CONSOLIDADA via BULK COLLECT / FORALL.
--            Erros individuais gravados em TB_LOG_NFE_REFORMA
--            via transação autônoma (gravar_log).
-- Fonte   : STG_NFE.CONTEUDO_XML
-- Destino : TB_REFORMA_CONSOLIDADA
...
-- ============================================================
    ...
    CURSOR c_docs IS
        SELECT /*+ PARALLEL(32) */
           ...
           ROUND(TO_NUMBER(NVL(det.I16_VFRETE_STR, '0'), '99999999999990.9999999999', 'NLS_NUMERIC_CHARACTERS = ''. '''), 2) AS I16_VFRETE,
           det.I17B_INDTOT,
        ...
        FROM stg_nfe t,
             ...
             XMLTABLE (
                 ...
                 COLUMNS 
                     ...
                     -- 001 - ajuste no campo frete
                     I16_VFRETE_STR   VARCHAR2(30) PATH 'prod/vFrete',
