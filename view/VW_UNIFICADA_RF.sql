-- ============================================================
-- Tipo    : VIEW
-- Objeto  : VW_UNIFICADA_RF
-- Schema  : USER_XMLS
-- Descricao: View central da Reforma Fiscal. Unifica todos os
--            dados da NF-e (emitente, destinatario, produtos,
--            tributos antigos e novos tributos RF: IS, IBS, CBS)
--            a partir de TB_UNIFICADA_RF.
--            Consumida por PRC_NFE_GERAR_XLSX para geracao
--            do arquivo de auditoria fiscal (XLSX/CSV).
-- Fonte   : TB_UNIFICADA_RF
-- ------------------------------------------------------------
-- Historico de alteracoes:
-- 001 - 2026-06-03 - Substituida coluna I15_VDESC por
--                    I16_VFRETE (frete por item da NF-e)
-- ============================================================
...
(
  ...
  , I14_QTRIB
  , I14A_VUNTRIB
  , I16_VFRETE   -- 001 - ajuste no campo frete (substituiu I15_VDESC)
  , ICMS_ORIG
  , ICMS_CST
  , ICMS_CSOSN
  , ICMS_VBC
